   ...
   <div class="footFlex d-flex">
     ...
     <div class="footMiddle d-flex">
       <div class="footContact">
         <span class="footTitle h5eng">CONTACT</span></br>
         <span class="contacttext bodytexteng">Hoba Wawi, Wanokaka,</br>
         West Regency, East Nusa</span></br>
         <span class="contacttext bodytexteng">
           TEL:+62 361 757149</span></br>
         <span class="contacttext bodytexteng">
           E-MAIL:
           ArcadiaResort<br>
           @service.com</span>
       ...
       <div class="NAVIGATE">
         <ul>
           ...
           <li class="footNavLink bodytexteng">
             <a href="<?= WEB_ROOT ?>/proj_arcadia/_about.php">ABOUT</a>
           </li>

           <li class="footNavLink bodytexteng">
             <a href="<?= WEB_ROOT ?>/proj_arcadia/_room.php">ROOM</a>
           </li>

           <li class="footNavLink bodytexteng">
             <a href="<?= WEB_ROOT ?>/proj_arcadia/_experience.php">EXPERIENCE</a>
           </li>

           <li class="footNavLink bodytexteng">
             <a href="<?= WEB_ROOT ?>/proj_arcadia/_wedding.php">WEDDING</a>
           </li>

           <li class="footNavLink bodytexteng">
             <a href="<?= WEB_ROOT ?>/proj_arcadia/_facility.php">FACILITY</a>
           </li>

           <li class="footNavLink bodytexteng">
             <a href="<?= WEB_ROOT ?>/proj_arcadia/_gallery.php">GALLERY</a>
           </li>

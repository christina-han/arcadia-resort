...
<div class="wrapper1">
    ...
    <div class="experiences" id="experiences">
        <div class="container-experiences1" data-aos="fade-up">
            <div>
                <ul class="Exlist">
                    <li>
                        <a href="#lobbylink" class="exiconbutton">
                            <svg>
                    ...
                    <li>
                        <a href="#poollink" class="exiconbutton">
                            <svg>
                                <use xlink:href="#pool" />
                            </svg>
                        </a>
                    ...
                    <li>
                        <a href="#gymlink" class="exiconbutton">
                            <svg>
                                <use xlink:href="#gym" />
                            </svg>
                        </a>
                    ...
                    <li>
                        <a href="#movietheaterlink" class="exiconbutton">
                            <svg>
                    ...
                    <li>
                        <a href="#nightbar" class="exiconbutton">
                            <svg>
                                <use xlink:href="#bar" />
                            </svg>
                        </a>
                    ...
                    <li>
                        <a href="#gameroom" class="exiconbutton">
                            <svg>
    ...
    <div class="facility-MainContent">
        <div class="boxFacility">
            ...
            <div class="facilityTitle h4chi" data-aos="fade-up" id="lobbylink">
                交誼廳
            </div>
    ...
    <div class="facility-MainContent">
        <div class="boxFacility">
            ...
            <div class="facilityTitle h4chi" data-aos="fade-up" id="poollink">
                游泳池
            </div>
    ...
    <div class="facility-MainContent">
        <div class="boxFacility">
            ...
            <div class="facilityTitle h4chi" data-aos="fade-up" id="gymlink">
                健身房
            </div>
    ...
    <div class="facility-MainContent">
        <div class="boxFacility">
            ...
            <div class="facilityTitle h4chi" data-aos="fade-up" id="movietheaterlink">
                電影廳
            </div>
    ...
    <div class="facility-MainContent">
        <div class="boxFacility">
            ...
            <div class="facilityTitle h4chi" data-aos="fade-up" id="nightbar">
                望海酒吧
            </div>
            ...
            <div class="fishBGpositionUse">
                <img class="facilityBG fishBGpositionInside" src="icon/7_facility/facility_5fish2.png" style="width: 400px;" alt="">
            </div>
        </div>
    </div>
    ...
    <div class="facility-MainContent">
        <div class="boxFacility">
            ...
            <div class="facilityTitle h4chi" data-aos="fade-up" id="gameroom">
                遊戲室
            </div>

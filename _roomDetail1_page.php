            ...
            <div class="btnlistbox" style="width:190px;">
                <div class="smallButton">
                    <li class="s_var_nav">
                        <div class="s_link_bg"></div>
                        <div class="s_link_title">
                            <a href="<?= WEB_ROOT ?>/proj_arcadia/_roomDetail2.php"><span>Read More</span></a>
                        </div>
                    </li>
                </div>
            </div>
            ...
            <div class="btnlistbox" style="width:190px">
                <div class="smallButton">
                    <li class="s_var_nav">
                        <div class="s_link_bg"></div>
                        <div class="s_link_title">
                            <a href="<?= WEB_ROOT ?>/proj_arcadia/_roomDetail3.php"><span>Read More</span></a>
                        </div>
                    </li>
                </div>
            </div>
            ...
            <div class="btnlistbox" style="width:190px">
                <div class="smallButton">
                    <li class="s_var_nav">
                        <div class="s_link_bg"></div>
                        <div class="s_link_title">
                            <a href="<?= WEB_ROOT ?>/proj_arcadia/_roomDetail4.php"><span>Read More</span></a>
                        </div>
                    </li>
                </div>
            </div>

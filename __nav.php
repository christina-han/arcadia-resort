...
<div id="menu2" class="x2">
    <section class="linebuttons h5eng">
      ...
      <div class="linebuttons_container lineBtn_nav">
        ...
        <a class="btnfos2 btnfos-2 btnfos- navlinkcolor" href="/proj_arcadia/_index.php" style="text-decoration: none;">
          HOME
        </a>
        <a class="btnfos2 btnfos-2 btnfos- navlinkcolor" href="/proj_arcadia/_about.php" style="text-decoration: none;">
          ABOUT
        </a>
        <a class="btnfos2 btnfos-2 btnfos- navlinkcolor" href="/proj_arcadia/_room.php" style="text-decoration: none;">
          ROOM
        </a>
        <a class="btnfos2 btnfos-2 btnfos- navlinkcolor" href="/proj_arcadia/_experience.php" style="text-decoration: none;">
          EXPERIENCE
        </a>
        <a class="btnfos2 btnfos-2 btnfos- navlinkcolor" href="/proj_arcadia/_wedding.php" style="text-decoration: none;">
          WEDDING
        </a>
        <a class="btnfos2 btnfos-2 btnfos- navlinkcolor" href="/proj_arcadia/_facility.php" style="text-decoration: none;">
          FACILITY
        </a>
        <a class="btnfos2 btnfos-2 btnfos- navlinkcolor" href="/proj_arcadia/_gallery.php" style="text-decoration: none;">
          GALLERY
        </a>
      </div>
    </section>
  ...
  <div class="x1" style="position: fixed; z-index: 9999;">
          ...
          <ul id="menu">
            ...
            <section class="linebuttons">
              <div class="linebuttons_container">
                ...
                <a class="btnfos btnfos-2 hamberlinkcolor" href="/proj_arcadia/_index.php">
                  <li class="h5eng">HOME</li>
                </a>
                <a class="btnfos btnfos-2 hamberlinkcolor" href="/proj_arcadia/_about.php">
                  <li class="h5eng">ABOUT</li>
                </a>
                <a class="btnfos btnfos-2 hamberlinkcolor" href="/proj_arcadia/_room.php">
                  <li class="h5eng">ROOM</li>
                </a>
                <a class="btnfos btnfos-2 hamberlinkcolor" href="/proj_arcadia/_experience.php">
                  <li class="h5eng">EXPERIENCE</li>
                </a>
                <a class="btnfos btnfos-2 hamberlinkcolor" href="/proj_arcadia/_wedding.php">
                  <li class="h5eng">WEDDING</li>
                </a>
                <a class="btnfos btnfos-2 hamberlinkcolor" href="/proj_arcadia/_facility.php">
                  <li class="h5eng">FACILITY</li>
                </a>
                <a class="btnfos btnfos-2 hamberlinkcolor" href="/proj_arcadia/_gallery.php">
          ...
          <?php if (isset($_SESSION['members'])) : ?>
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdown" style="background-color:#09839C">
                <a class="dropdown-item h5chi" href="/proj_arcadia/_member.php">會員中心</a>
                <a class="dropdown-item h5chi" href="/proj_arcadia/orderrecord.php">訂單紀錄</a>

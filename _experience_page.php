...
<div class="wrapper1">
  <div class="top">
    <div class="title h2eng" data-aos="fade-right" data-aos-duration="1000">
      EXPERIENCE
    </div>
  ...
  <div class="experiences"id="experiences">
    <div class="container-experiences1" data-aos="fade-up" >
      <div>
        <ul class="Exlist">
          <li>
            <a href="#Oceanbox" class="exiconbutton">
              <svg>
          ...
          <li>
            <a href="#Junglebox" class="exiconbutton">
              <svg>
          ...
          <li>
            <a href="#Yogabox" class="exiconbutton">
              <svg>
          ...
          <li>
            <a href="#cbox" class="exiconbutton">
              <svg>
...
<div class="experiencebackgroundcolor" id="Oceanbox">

  <section id="tab1" class="carousel Ocean-MainContent exmain" >

    <div class="container boxEx" >

      <div class="OceanTitle"   data-aos="fade-up" >
        ...
        <div class="slide-belt d-flex">
          ...
          <div class="slide-pair">
            ...
            <div class="AlignEXContent">
              ...
              <div class="Container-Part" data-aos="fade-up" >
                <div class="ExPics hover-zoom-in">
                  <img class="coverfit" src="img/5_experience/experience_2ocean.jpg" alt="diving">
                </div>
              </div>

              <div class="AlignTextCard" data-aos="fade-right" data-aos-duration="1000">
  ...
  <section id="tab2" class="carousel Ocean-MainContent exmain">
    ...
    <div class="container boxEx" id="Junglebox">
            ...
            <div class="AlignEXContent">
              ...
              <div class="AlignTextCard">
                <div class="ExTextCard">
                  ...
                  <div class="aligntext">
                    <span class="bodytextchi">記錄著歷史興衰、朝代更替的古蹟，<br>
                    是每一個到ARCADIA的人必去之地。<br><br>
                      歷經政權朝代更迭、戰爭動亂洗禮的古蹟，<br>
                      讓人不經意間就會感受到歷史的厚重感，<br>
                      也使傳奇色彩濃厚的古蹟更加美麗而神秘。</span>
                  </div>
                </div>
              </div>
  ...
  <section id="tab3" class="carousel Ocean-MainContent exmain">
    ...
    <div class="container boxEx" id="Yogabox">
            ...
            <div class="AlignEXContent">
              ...
              <div class="AlignTextCard"  >
                <div class="ExTextCard">
                  ...
                  <div class="aligntext">
                    <span class="bodytextchi">享受一場與自我的對話！<br><br>
                      旅行不是尋找新的風景，<br>而是新的視野與體驗，<br>
                      專業瑜伽老師帶你一起深呼吸，<br>進行平衡身心的瑜珈練習。<br>
                      將旅行帶來的省思儲存在身體裡，<br>提醒自己原來心靈擁有這麼多自由與美好。</span>
                  </div>
                </div>
              </div>
  ...
  <section id="tab4" class="carousel Ocean-MainContent exmain">
    ...
    <div class="container boxEx" id="cbox">
            ...
            <div class="AlignEXContent">
              ...
              <div class="AlignTextCard">
                <div class="ExTextCard">
                  ...
                  <div class="aligntext">
                    <span class="bodytextchi">尾牙是慰勞公司員工一整年的最佳時機，<br>
                      而春酒則是慶祝一年的豐收和到來，<br>
                      對於公司來說是非常重要的日子，<br>當然要好好慶祝囉！<br>
                      不但能讓一整年事業更加順利，<br>也能讓員工為公司更加傾力。</span>
                  </div>
                </div>
              </div>

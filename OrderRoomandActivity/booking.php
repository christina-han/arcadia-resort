...
<!-- orderlist  -->      
    <div class="checkorder rwddisplaynone">
        ...
        <div class="confirm">
            ...
            <img src="/123/img/icon/arrow.svg" alt="">
...
<!-- rwd orderlist -->
           ...
           <div class="rwdonly">
           <div class="rwdfix">
            <button class="bookDetail bodytextchi" data-target="#exampleModal5" data-toggle="modal" type="button">查看訂單</button>    
        ...
        <script>
            ...
            $('.buy-button').on('click', function() {
               ...
               console.log(duration);
                ...
                <div class="line"></div>
            <div class="day">
            <span class="totalPrice h4chi">小計</span>

...
<button class="skpBtn rwdBtn" href="">跳過活動選擇</button> 
        ...
        <div class="orderList rwddisplaynone">
            <div class="order">
                ...
                for ($i = 0; $i < $num; $i++) : ?>
                    ...
                    <div class="infoImg">
                        <img class="coverfit" src="/proj58/123/img/activity/roomOverview-room3.jpg" alt="">
                    </div>
    ...
    <img src="/proj58/proj58/123/img/experience-dinner01.jpg" alt="">

     <!-- rwd orderlist -->
            <!-- Button trigger modal -->
            <div class="rwdonly">
           <div class="rwdfix">
            <button class="bookDetail bodytextchi" data-target="#exampleModal" data-toggle="modal" type="button">查看訂單</button>    
            <button class="rwdconfirmBtn confirmBtn h5eng">Confirm<img src="/Arcadia/icon/arrow.svg" alt=""></button>                                     
        </div> 
                 <!-- Modal -->
    ...
    <script>
        const allactive = {
            ac1: {
                acname: 'A.浮潛潛水',
                acprice: 3500,
                acimg: '/proj58/123/img/activity/experience-sea-diving01.jpg',
            },
            ac2: {
                acname: '衝浪體驗',
                acprice: 1800,
                acimg:'/proj58/123/img/activity/experience-sea-surf01.jpg'
            },
            ac3: {
                acname: '生態探訪',
                acprice: 800,
                acimg:'/proj58/123/img/activity/experience-jungle-eco01.jpg'
            },
            ac4: {
                acname: '古蹟尋訪',
                acprice: 800,
                acimg:'/proj58/123/img/activity/experience-jungle- historic.jpg'
            },
            ac5: {
                acname: '薰香按摩',
                acprice: 2500,
                acimg:
               '/proj58/123/img/activity/activityexperience-lesson-massage01.jpg'
            },
            ac6: {
                acname: '紓壓瑜珈',
                acprice: 1800,
                acimg:'/proj58/123/img/activity/experience-lesson-yoga.jpg'
            },
            ac7: {
                acname: '派對規劃',
                acprice: 10000,
                acimg:'/proj58/123/img/activity/experience-party02.jpg'

            },
            ac8: {
                acname: '尾牙春酒',
                acprice: 10000,
                acimg:'/proj58/123/img/activity/experience-dinner01.jpg'

            },
            ac9: {
                acname: '求婚服務',
                acprice: '價格另計',
                acimg:'/proj58/123/img/activity/experience-weading-propose01.jpg'

            },
            ac10: {
                acname: '婚宴服務',
                acprice: '價格另計',
                acimg:'/proj58/123/img/activity/experience-wedding-wedding.jpg'
            },
        }

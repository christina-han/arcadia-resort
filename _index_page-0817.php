...
<div class="wrapper1">
    ...
    <!-- -------------------- -->
    <div class="welcome">
        <div class="welcomeLinebox" data-aos="fade-in" data-aos-offset="100" data-aos-easing="ease-in-out" data-aos-mirror="true"
 data-aos-once="false"
 data-aos-anchor-placement="top-center"></div>

        <img data-aos="fade-in" data-aos="fade-in" data-aos-offset="100" data-aos-easing="ease-in-out" data-aos-mirror="true"
 data-aos-once="false"
 data-aos-anchor-placement="top-center" src="icon/1_index/index_1brush.png" alt="">
    ...
    <div class="about">
        ...
        <img data-aos="fade-in" data-aos-offset="300" data-aos-easing="ease-in-sine" class="BGsvg" src="icon/1_index/index_2bubble.png" alt="">
        ...
        <div class="aboutRight">
            ...
            <div class="sidePic">
                <img class="coverfit parallaxPic1" src="img/1_index/index_2about.png" alt="">
            </div>
        </div>
    ...
    <div id="carouselExampleInterval" class="roomPic carousel slide middlePic" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active" data-interval="10000">
                <img src="img/1_index/index_3roomAll1.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item" data-interval="2000">
                <img src="img/1_index/index_3roomAll2.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="img/1_index/index_3roomAll3.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="img/1_index/index_3roomAll4.jpg" class="d-block w-100" alt="...">
            </div>
        </div>
...
<div class="experience">
    ...
    <div class="experiencePic">
        <img src="icon/1_index/index_3fish.png" alt="">

        <div class="experiencePicLeft">
            <img src="img/1_index/index_4experience1.png" style="margin: 0;" alt="">
            <img src="img/1_index/index_4experience2.png" style="margin: 0;" alt="">
        </div>
...
<div class="wedding">
    <div class="weddingBG"><img src="icon/1_index/index_4bird.png" alt=""></div>
    <div class="titleM">
        <div class="h4eng colorGreen">WEDDING</div>
    </div>

    <img class="middlePic" src="img/1_index/index_5wedding.png" alt="">
...
<div class="facility">
    ...
    <div class="facilityLeft">
        ...
        <div class="sidePic">
            <img class="coverfit" src="img/1_index/index_6facility.png" alt="">
        </div>

    </div>

    <div class="facilityRight">
        <img src="icon/1_index/index_5leaf.png" alt="">
        <div class="titleWeb">
            <div class="h4eng sideText colorGreen">
                FACILITY</div>
        </div>
...
<div class="comment">
    ...
    <div id="carouselExampleInterval" class="roomPic carousel slide middlePic" data-ride="carousel" style="z-index: -1;">
        <div class="carousel-inner">
            <div class="carousel-item active" data-interval="10000">
